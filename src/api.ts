...
const CURATED_ADS_BY_PLACEMENT: Record<string, AdItem[]> = Object.fromEntries(
  ['home', 'deposit', 'mining', 'profile'].map((placement, placementIndex) => [
    placement,
    [
      { id: 991000 + placementIndex * 10 + 1, type: 'image', mediaUrl: '/uploads/ads/mani.jpeg', title: 'Deposit', description: 'Open the deposit page', linkUrl: '/deposit', placement, sortOrder: 0, isActive: true },
      { id: 991000 + placementIndex * 10 + 2, type: 'image', mediaUrl: '/uploads/ads/frnd.jpeg', title: 'Invite & Earn', description: 'Open referral center', linkUrl: '/referral', placement, sortOrder: 1, isActive: true },
    ],
  ]),
)
